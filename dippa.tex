...
A process is a set of set of actions done in a sequnce that aim for a certain outcome. A sales process is a set of actions, typically related to the sales persons task that aim for selling the product. In this section I go throught the forces that have influeced the sales process. Finally I present the reserach done psecifially on the field of technology selling. 

\subsection{Seven steps of personal selling}

The seven steps of personal selling is one of the most oldest and most referred to processes in the field of sales. It was originally published by Dubinsky in 1980. \citep{Dubinsky:1980/81}

...
\emph{Prospecting}
Prospecting is the first phase of the process where a salesperson is searching for new potential customers. The purpose is to find customers who have not yet purchased from the company. This phase also usually includes qualifiying the prospect as a potential one. 
\emph{Preapproach}

...
After Dubinskys reserach the \emph{Personal Selling Process} reached a saturated version comrising of the steps related to the activities of the sales people. 
\newline
\emph{Prospecting}\newline
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=9cm]{7 step process.png}
    \caption{The seven step personal selling}
    \label{fig:eeyore}
  \end{center}
\end{figure}

\subsection{Customer Centirc approach}

...
Buying Center & all those members who become involved in the buying process for a particular product or service \\
...
Tässä osiossa esittelen sievon yrityksenä myyntiorganisaation nykyistä toimintaan ja toivottuja tuloksia tutkimukselta.

\section{Sievo as a company}

Sievo is a software company found in 2003. The slogan "Advancing procurement performance" captures Sievo's mission. Sievo provides a sophisticated procurement performance management software that enables visibility on corporate spending, measurement of procurement contribution and tracking of contract compliance. Transaction data is gathered on a recurring basis from the customer ERP and measurements and reports are build on top of that. 

The headquarters is located in Helsinki where the majority of the 40 employees is also based. Sievo also has sales offices in Paris, Stockholm, Frankfurt and Dubai. Currently Sievo serves over 30 clients globally. Users of the Sievo software are located all over the world. 
...
Presales was introduced to Sievo's organization in September 2012. Since the it has searched its ways of working and process to find the optimal processes. Currently presales acts as an interface between the sales team, prospects and the rest of the company. The main role is to support the sales team with the more technical issues and do software demonstrations and exceute proof of concepts. Presales is also responsible for carrying out the RFP processes according to the defined process. 

Mikä on presales tämän hetkinen rooli. Miten se toimii suhteessa muuhun firmaan

\section{Internal expectation for the study}

Define the role of presales in relation to the rest of the organisation. 
...
Fundamentally defining the sales begins with understanding the buying process. In this chapter I will introduce the theories behind the buying. The buying situations are all very different from one another since they deeply depend on the particular purchase at hand.
 There are several elements in the particular purchase that define the buying behavior. Lewin and Donthu have consolidated these dimensions in their study. 

Based on the consolidation research done by Lewin and Donthu (2005) I will define the scope of the organisational buying behavior teory I will focus. 
ostotilanteita on paljon erilaisia ja erityyppisiä. 
Nää tyypit on hahmottaneet ne päädimensiot miten määritelä ostotilanteet. 
Based on this research we identify the factor determining our type of purchases. 
Näitä softa ostoja määrittävät tekijät. 
...
New- task buying passes through several stages: awareness, interest, evaluation, trial and adoption.
Business buyers makes the fewest decisions in the straight-rebuy situation and the most in the new task situation. Different decision participants influence each decision \citep{Kotler}
...
Buying psykology - human side of selling
Companies do not buy - people do
Each party in the buying process has subtle roles and need that the sales has to address.
The involvement of many people in the purchase decision creates a group dynamic that the selling company must factor into its sales planning. Who makes up the buying group? How will the parties interact? Who will dominate? What priorities do the individuals have.
Effective selling requires usefully combining the individual and group dynamics to predict what the buying "decision making unit" will do \citep{Bonoma}

Other department personnel are more influental in a new buy situations. 
More lateral involvement

the buying center includes all members that play any of the seven roles. 

\newline \newline \emph{Initiators}\newline 
Those who beging the purchase process \citep{}\newline \newline
\emph{Users}\newline 
Those who actually use the product\citep{}\newline \newline
\emph{Influencers}\newline
Those who provide information and add decision criteria throughtout the process \citep{} \newline \newline
\emph{Deciders}\newline
Those who have authority to select the supplier   \citep{}\newline \newline
\emph{Approvers}\newline
Those who authorize the proposed actions of deciders or buyers \citep{}\newline \newline
\emph{Buyers}\newline
Those who have authority to execute the contractual arrangements \citep{} \newline \newline
\emph{Gatekeepers}\newline
Those who control the flow of information. Could be secretaries, receptionist or anyone who can prevent access to a DMU member, or a buyer whose agreements must be sought before a supplier can contact other member of the DMU  \citep{Moncrief}

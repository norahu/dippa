...
There are multiple ways to imprice the value preceived by the customer. The firts one is to seek to measure the actual value the product brings with it self and if that is higher then the competitor's. The second is to also measure the value the cutsomer bring to the selling organisation in the role of a good reference for instance. 

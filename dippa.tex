...
\newcommand{\SUBTITLE}{Case Sievo: How presales should be organized at Sievo? }
...
Tässä kuvailen ongelman yleisellä tasolla ja mihin tutkimuskysymyksiin haen ratkaisua

\section{Constructive case study}
...
Kuvailen myynnin nykytilaa ja sen kipukohtia. Miten myynti on nyt organisoitunut.
Maybe joku organisaatio kaavio. 
Mikä on myynnin prosessi? 
...
\subsection{Myyntiprosessi 'as is'}

Mitä Sievo odottaa tältä tutkimukselta. Mikä olisi toivottu lopputulos. 
...
\section{Expectation for the Thesis}
...
In the theory part of my thesis I will first go through the development of sales processes and all the forces that have influenced that leading what the theory about high-technology, software sales is today. Then I will look the same process from the buyer side; the roles, processes and requirements. Finally I will explain the basic of service concept development based on which I will develop my recommendation for the presales. 


\section{Sales process}
\label{sec:environments}
A process is a set of set of actions done in a sequence that aim for a certain outcome. A sales process is a set of actions that target to reach a sale. In this section I go throught the forces that have influeced the sales process throught out the evolution. I will lead this subject towards the specific theme of software sales proces.  
it is a technique, based on the actions required from the sales rep. 

\subsection{Seven steps of personal selling}

The seven steps of personal selling is one of the most oldest and most referred to processes in the field of sales. It was originally published by Dubinsky in 1980. Dubinsky studied the selling techniques of sales people and tried to distuiguish on what techniques do the sales reps themselves put more emphasis on. The study identified the underlying dimension that characterize the techniques sales people use in the \emph{Personal Selling Process} \citep{Dubinsky}

Dibinsky also noted that rather than being separate activities these can be described systematically. Resulting that selling can be seen as a process. 

Before Dubinsky the \emph{Personal Selling Process} was already identified and different authors that diffreing opinion on what the steps the process included

After Dubinskys research the \emph{Personal Selling Process} reached a saturated version comprising of the steps related to the activities of the sales people. 
It was seen as a continuium to marketing in the form of most expansive marketing. 
\newline \newline \emph{Prospecting}\newline 
Prospecting is the first phase of the process where a salesperson is searching for new potential customers. The purpose is to find customers who have not yet purchased from the company. This phase also usually includes qualifiying the prospect as a potential one. \citep{Jobber}\newline \newline
\emph{Preapproach}\newline 
Preapproaching phase is the investigation phase before the actual visit. It includes the salesperson getting to know the customers need, industry, seeing for potential past correnpondance and preparing material for the actual meeting. \citep{Moncrief}\newline \newline
\emph{Approach}\newline
The approch could also be referred as the first impression. It is the first moments with the customer when the trust and impression are made. Dubinsky mentions that at this stage several different types of approaches might be taken for example the product approach, consumer approach, the consultative approach. \citep{Dubinsky} \newline \newline
\emph{Presentation}\newline
The presentation is the main part of the meeting and require an adequate amount of preparations. This includes sharing the information regarding the product and demonstrations. It could be one meeting or occurs in several instances. \citep{Moncrief}\newline \newline
...
\emph{Follow-up}\newline
The follow-up step, also refered as post-sale includes the assumption that the sales is not over with the order. After the order the salesperson makes sure that everything is operating smoothly and the customer is happy. \citep{Dubinsky}
\newline 
...
The concept of putting the customer first is not new but it has definitely risen its importance during the past decade. \citp{Bolton} ~\citep{Shah}

Companies used to be more product-centered and customer centered. Their were aiming for profits of economies of scale with high productivity and low cost. They were oriented towards internal process development and towards their own purchases. 

The awareness of such metrics and customer satisfaction, customer loyalty, quality preceived by the customer had a growing importance. They have driven the companies to increase their understanding of the customers and how to serve them better. Recent studies have also show the correlation of a company's financial performance with the degree of customer centricity. 

The heart of costumer centricity lies if creating a win win situation; selling products and delivering value to the customer. \citep{Shah}

There are multiple ways to imprice the value preceived by the customer. The first one is to seek to measure the actual value the product brings with it self and if that is higher then the competitor's. The second is to also measure the value the cutsomer bring to the selling organisation in the role of a good reference for instance. 

The idea in customer centricity is not only set the sales to better serve the customer but the direct the whole organisation to serve the customer better. This also means alinging the product development, implementation, hr and other fucntion towards the customers need and interests. The whole organisation should be on the mission on serving the customer better. It is not enough anymore that the sales act as an interface towards the customer. 

The emphasis is on valuing the relationship with the customer. 

\newline

Along with this new philosophy other factors have affect the evolvement of the sales process. Such as the new technology at hand, the role of selling and the increased knowledge on the buyer side.  
...
The high complexity fo the technology services and products make it's purchasing also complex. Usually that acquire thorough capital and technical considerations. This set also higher expectation to the sales side. The salesperson is seen more as a consultant solving the problem. 

Sales should be organized around tackling the customer's problem and usually a single salesperson is not enough. The selling in typically done in teams with multidiscliplinary functions to answer the customer concern thoroughly. The sales needs to know also about the technical details and fullfilment. 

The people skills required from the sales side also have a new meaning. The sales should be able to orchestrate the internal resources to satisfy the clients needs. The sales acts are the main gate of information between the customer and the rest of the organization. Also the task of the sales is to conduit the information about customer problem to the R&D team in order to facilitate new product innovation. 

what makes high tech special
- high levels of product complexity that require more in-dept communications about high-tech products and services
- sales should be integratd with the rest of the firm. 
- the process of selling more complete solutions rather than merely stand-alone products require solution selling
- sales people are major conduits of information. customer needs come first
- increase in educational level of the sales force. seller and buyer engineers engage in co-development and long-term collaborative relationships. 
- the sales people act as remote members of the customer's R&D team. 
- sales people offer technical support, maintain technical dialogue, social + technical skills required. 
- role of the sales person is more a consultant
- sales people need to become experts in the fullfilment also. 

why should sold as solutions
- product complexity requires more educated sales force. 
- sales is a key source of information toward product development
- high tech buying is complex due to complicated capital and technological considerations. 
- the use of sales teams. people from multiple functional areas. teams need to be composed of multidisiplinary specialits. 
- 
...
implication on the sales process
- towards problem identification, presentation of the solution, continued customer support

\subsection{Future of solution selling}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=9cm]{seven.jpg}

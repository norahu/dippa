...
A process is a set of set of actions done in a sequnce that aim for a certain outcome. A sales process is a set of actions that target to reach a sale. In this section I go throught the forces that have influeced the sales process throught out the evolution. I will lead this subject towards the specific theme of software sales proces.  

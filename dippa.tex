...
It was seen as a continuuim to marketing in the form of most expansive marketing. 
...
\emph{Approach}\newline
The approch could also be refered as the first impression. It is the first moments with the customer when the trust and impression are made. Dubinsky mentions that at this stage several different types of approaches might be taken for example the product approach, consumer approach, the consultative approach. \citep{Dubinsky} \newline \newline
\emph{Presentation}\newline
...
\emph{Follow-up}\newline
The follow-up step, also refered as post-sale includes the assumption that the sales is not over with the order. After the ordr the salesperson makes sure that everything is operating smoothly and the customer is happy. \citep{Dubinsky}
\newline 
...
The emphasis is on valueing the relationship with the customer. 

\newline
\emph{Customer centricity on the sales process}
\newline \newline
- technology
- expnading stretegic role of selling
- team-based approach of selling
- increased buyer knowledge
These factor affect the transformation of the sales process. 

\newline \newline
\emph{Prospecting - Customer retention and deletion}\newline 
...
\emph{Approach - Nurturing the reltionship}\newline
Sice nowadays much effort is put on building the relationship with the customer the selling activites have also been directed towards that. Relationship maintenance is a long term process. In the traditional approach this step was about making the first impression and in an updated version it serves more for the activities to build the foundation for the relationship. \citep{Moncrief} \newline \newline
\emph{Presentation - Narketing the product}\newline
